const ru = {
    ...
    "preset_desc": "Применить шаблон канала (Игры, Музыка, VIP и т.д.)",
  ...
  "rate_limit_exceeded": "Слишком частые действия. Подождите немного.",
  "cannot_trust_self": "Вы не можете доверять самому себе.",
  "cannot_untrust_self": "Вы не можете убрать доверие к самому себе.",
  "cannot_block_self": "Вы не можете заблокировать самого себя.", 
  "cannot_invite_self": "Вы не можете пригласить самого себя.",
  "cannot_kick_self": "Вы не можете выгнать самого себя.",
  "cannot_transfer_to_self": "Вы не можете передать владение самому себе.",
  "cannot_block_admin": "Вы не можете заблокировать администраторов сервера.",
  "cannot_kick_admin": "Вы не можете выгнать администраторов сервера.",
  "cannot_kick_higher_role": "Вы не можете выгнать пользователей с более высокими ролями.",
  "cannot_transfer_to_bot": "Вы не можете передать владение боту.",
  "user_not_blocked": "{user} не заблокирован.",
  "user_already_in_channel": "{user} уже находится в этом канале.",
  "cannot_invite_blocked_user": "Вы не можете пригласить заблокированного пользователя.",
  "error_create_invite": "Не удалось создать ссылку-приглашение.",
  "kick_failed": "Не удалось выгнать {user}.",
  "transfer_failed": "Не удалось передать владение.",
  "invalid_bitrate": "Выбран недействительный битрейт.",
  "invalid_region": "Выбран недействительный регион.",
  "ownership_transferred_dm": "Вы стали владельцем голосового канала '{channel}' в {guild}. Передано от {from}.",
  "log_dnd": "{user} {status} режим «Не беспокоить» в {channel}.",
  "log_trust": "{user} получил доверие в {channel} от {by}.",
  "log_untrust": "У {user} убрано доверие в {channel} пользователем {by}.",
  "log_block": "{user} заблокирован в {channel} пользователем {by}.",
  "log_unblock": "{user} разблокирован в {channel} пользователем {by}.",
  "log_invite": "{user} приглашен в {channel} пользователем {by}.",
  "log_kick": "{user} выгнан из {channel} пользователем {by}.",
  "log_transfer": "Владение {channel} передано от {from} к {user}.",
  "permissions_restored": "Восстановлены права владельца для {user} в {channel}."
}
