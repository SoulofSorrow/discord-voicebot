const de = {
  ...
  "preset_desc": "Kanal-Vorlage anwenden (Gaming, Musik, VIP, etc.)",
  ...
  // Rate Limiting
  "rate_limit_exceeded": "Du machst das zu oft. Bitte warte einen Moment.",
  
  // Selbst-Aktionen-Schutz
  "cannot_trust_self": "Du kannst dir nicht selbst vertrauen.",
  "cannot_untrust_self": "Du kannst dir nicht selbst das Vertrauen entziehen.",
  ...
  // Admin/Bot-Schutz
  "cannot_block_admin": "Du kannst Server-Administratoren nicht blockieren.",
  "cannot_kick_admin": "Du kannst Server-Administratoren nicht kicken.",
  "cannot_kick_higher_role": "Du kannst Nutzer mit höheren Rollen nicht kicken.",
  "cannot_transfer_to_bot": "Du kannst den Besitz nicht an einen Bot übertragen.",
  
  // Status-Überprüfungen
  "user_not_blocked": "{user} ist nicht blockiert.",
  "user_already_in_channel": "{user} ist bereits in diesem Kanal.",
  "cannot_invite_blocked_user": "Du kannst einen blockierten Nutzer nicht einladen.",
  
  // Fehlermeldungen
  "error_create_invite": "Einladungslink konnte nicht erstellt werden.",
  "kick_failed": "{user} konnte nicht gekickt werden.",
  "transfer_failed": "Besitzübertragung fehlgeschlagen.",
  "invalid_bitrate": "Ungültige Bitrate ausgewählt.",
  "invalid_region": "Ungültige Region ausgewählt.",
  
  // Erfolgsmeldungen
  "ownership_transferred_dm": "Du bist jetzt Besitzer des Sprachkanals '{channel}' in {guild}. Übertragen von {from}.",
  
  // Erweiterte Log-Keys
  "log_dnd": "{user} hat den Nicht-Stören-Modus in {channel} {status}.",
  "log_trust": "{user} wurde in {channel} von {by} vertraut.",
  "log_untrust": "{user} wurde das Vertrauen in {channel} von {by} entzogen.",
  "log_block": "{user} wurde in {channel} von {by} blockiert.",
  "log_unblock": "{user} wurde in {channel} von {by} entblockt.",
  "log_invite": "{user} wurde von {by} in {channel} eingeladen.",
  "log_kick": "{user} wurde von {by} aus {channel} gekickt.",
  "log_transfer": "Besitz von {channel} wurde von {from} an {user} übertragen.",
  "permissions_restored": "Besitzer-Berechtigungen für {user} in {channel} wiederhergestellt."
}
