const cn = {
  ...
  "rate_limit_exceeded": "操作过于频繁，请稍等片刻。",
  "cannot_trust_self": "你不能信任自己。",
  "cannot_untrust_self": "你不能取消信任自己。",
  "cannot_block_self": "你不能封锁自己。", 
  "cannot_invite_self": "你不能邀请自己。",
  "cannot_kick_self": "你不能踢出自己。",
  "cannot_transfer_to_self": "你不能将所有权转移给自己。",
  "cannot_block_admin": "你不能封锁服务器管理员。",
  "cannot_kick_admin": "你不能踢出服务器管理员。",
  "cannot_kick_higher_role": "你不能踢出拥有更高角色的用户。",
  "cannot_transfer_to_bot": "你不能将所有权转移给机器人。",
  "user_not_blocked": "{user} 未被封锁。",
  "user_already_in_channel": "{user} 已经在这个频道中。",
  "cannot_invite_blocked_user": "你不能邀请被封锁的用户。",
  "error_create_invite": "创建邀请链接失败。",
  "kick_failed": "踢出 {user} 失败。",
  "transfer_failed": "所有权转移失败。",
  "invalid_bitrate": "选择的比特率无效。",
  "invalid_region": "选择的区域无效。",
  "ownership_transferred_dm": "你现在是 {guild} 中语音频道 '{channel}' 的拥有者。由 {from} 转移。",
  "log_dnd": "{user} 在 {channel} 中{status}了勿扰模式。",
  "log_trust": "{user} 被 {by} 在 {channel} 中信任。",
  "log_untrust": "{user} 被 {by} 在 {channel} 中取消信任。",
  "log_block": "{user} 被 {by} 在 {channel} 中封锁。",
  "log_unblock": "{user} 被 {by} 在 {channel} 中解封。",
  "log_invite": "{user} 被 {by} 邀请到 {channel}。",
  "log_kick": "{user} 被 {by} 从 {channel} 踢出。",
  "log_transfer": "{channel} 的所有权从 {from} 转移到了 {user}。",
  "permissions_restored": "为 {user} 在 {channel} 中恢复了拥有者权限。"
}
