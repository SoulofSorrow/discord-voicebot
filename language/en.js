const en = {
    ...
    "preset_desc": "Apply channel template (Gaming, Music, VIP, etc.)",
  ...
  "cannot_untrust_self": "You cannot untrust yourself.",
  ...
  "cannot_block_admin": "You cannot block server administrators.",
  "cannot_kick_admin": "You cannot kick server administrators.",
  "cannot_kick_higher_role": "You cannot kick users with higher roles.",
  "cannot_transfer_to_bot": "You cannot transfer ownership to a bot.",
  "user_not_blocked": "{user} is not blocked.",
  "user_already_in_channel": "{user} is already in this channel.",
  "cannot_invite_blocked_user": "You cannot invite a blocked user.",
  "error_create_invite": "Failed to create invite link.",
  "kick_failed": "Failed to kick {user}.",
  "transfer_failed": "Failed to transfer ownership.",
  "invalid_bitrate": "Invalid bitrate selected.",
  "invalid_region": "Invalid region selected.",
  "ownership_transferred_dm": "You are now the owner of voice channel '{channel}' in {guild}. Transferred by {from}.",
  "log_dnd": "{user} {status} Do Not Disturb mode in {channel}.",
  "log_trust": "{user} was trusted in {channel} by {by}.",
  "log_untrust": "{user} was untrusted in {channel} by {by}.",  
  "log_block": "{user} was blocked from {channel} by {by}.",
  "log_unblock": "{user} was unblocked from {channel} by {by}.",
  "log_invite": "{user} was invited to {channel} by {by}.",
  "log_kick": "{user} was kicked from {channel} by {by}.",
  "log_transfer": "Ownership of {channel} was transferred from {from} to {user}.",
  "permissions_restored": "Restored owner permissions for {user} in {channel}."
}
